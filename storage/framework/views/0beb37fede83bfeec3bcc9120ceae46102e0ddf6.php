    ...
    <footer class="main-footer">
        ...
        <div class="footer-right">
            Dibuat dengan <i class="fas fa-heart text-danger"></i> oleh <a href="https://rafipriatna.id" target="_blank" rel="noopener noreferrer">Rafi Priatna K</a>
        </div>
    </footer><?php /**PATH D:\LARAPOS\LaraPOS\resources\views/layouts/footer.blade.php ENDPATH**/ ?>